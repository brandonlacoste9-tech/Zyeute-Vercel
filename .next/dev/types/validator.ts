...
// Validate ../../../src/app/(main)/explore/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<'/explore'>> = Specific;
  const handler = {} as typeof import('../../../src/app/(main)/explore/page.js');
  type __Check = __IsExpected<typeof handler>;
  // @ts-ignore
  type __Unused = __Check;
}
...
// Validate ../../../src/app/(main)/p/[id]/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<'/p/[id]'>> = Specific;
  const handler = {} as typeof import('../../../src/app/(main)/p/[id]/page.js');
  type __Check = __IsExpected<typeof handler>;
  // @ts-ignore
  type __Unused = __Check;
}
...
// Validate ../../../src/app/(main)/premium/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<'/premium'>> = Specific;
  const handler = {} as typeof import('../../../src/app/(main)/premium/page.js');
  type __Check = __IsExpected<typeof handler>;
  // @ts-ignore
  type __Unused = __Check;
}

// Validate ../../../src/app/(main)/profile/[slug]/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<'/profile/[slug]'>> = Specific;
  const handler = {} as typeof import('../../../src/app/(main)/profile/[slug]/page.js');
  type __Check = __IsExpected<typeof handler>;
  // @ts-ignore
  type __Unused = __Check;
}

// Validate ../../../src/app/(main)/success/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<'/success'>> = Specific;
  const handler = {} as typeof import('../../../src/app/(main)/success/page.js');
  type __Check = __IsExpected<typeof handler>;
  // @ts-ignore
  type __Unused = __Check;
}

// Validate ../../../src/app/(main)/upload/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<'/upload'>> = Specific;
  const handler = {} as typeof import('../../../src/app/(main)/upload/page.js');
  type __Check = __IsExpected<typeof handler>;
  // @ts-ignore
  type __Unused = __Check;
}
