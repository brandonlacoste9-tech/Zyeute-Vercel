...
export const Logo: React.FC<LogoProps> = ({
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              boxShadow: glowing
                ? '0 0 15px rgba(255,191,0,0.3), inset 0 0 15px rgba(255,191,0,0.1)'
                : 'none',
            }}
          />
          ...
          <div
            ...
            style={{ borderColor: 'rgba(255,191,0,0.6)' }}
          />
          <div
        ...
        <div className="flex flex-col items-center">
          <span
            ...
            style={{
              ...
              background:
                'linear-gradient(180deg, #FFE55C 0%, #FFD700 30%, #DAA520 70%, #B8860B 100%)',
  ...
  return (
    <Link href={linkTo} className="transition-transform hover:scale-105 duration-300">
      {logoContent}
    </Link>
  );
};
