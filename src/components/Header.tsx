  ...
  return (
    <header
      className={cn(
        ...
        'border-b border-gold-500/30', // Gold border instead of black
        'shadow-lg shadow-black/50',
        className
      )}
    >
      {/* Decorative Stitching Line */}
      <div className="absolute bottom-0 left-0 right-0 h-[1px] bg-gold-500/20"></div>
      <div className="absolute bottom-[3px] left-0 right-0 border-b border-dashed border-gold-500/30 opacity-50"></div>
