      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        {isLoading ? (
          ...
          <div className="leather-card rounded-2xl p-12 text-center stitched">
            ...
            <h3 className="text-xl font-bold text-gold-500 mb-2">Aucun produit trouvé</h3>
            ...
            {products.map((product) => (
              ...
              >
                ...
                <div className="relative aspect-square bg-leather-900">
                  ...
                  />
                  {/* Gold corner accent */}
                  <div className="absolute top-0 right-0 w-12 h-12 bg-gold-gradient opacity-30" style={{ clipPath: 'polygon(100% 0, 0 0, 100% 100%)' }} />
        ...
        <div className="leather-card rounded-2xl p-6 mt-8 stitched">
          ...
          <div className="grid md:grid-cols-3 gap-4 text-sm">
            <div className="flex gap-3">
              ...
              <div>
                <h4 className="text-white font-semibold mb-1">100% Québécois</h4>
                <p className="text-leather-300">Supporte les créateurs locaux</p>
              </div>
            </div>
            <div className="flex gap-3">
              <span className="text-gold-500 text-xl">🔒</span>
              <div>
                <h4 className="text-white font-semibold mb-1">Paiements sécurisés</h4>
