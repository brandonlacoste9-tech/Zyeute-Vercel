    ...
    <div className="min-h-screen bg-black leather-overlay pb-20">
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="leather-card rounded-xl p-6 stitched text-center">
          <div className="flex flex-col items-center gap-4">
            <div className="relative">
              ...
              />
              <label htmlFor="avatar-upload" className="absolute bottom-0 right-0 bg-gold-500 rounded-full p-2 cursor-pointer hover:bg-gold-600 transition-colors">
            ...
            <label htmlFor="avatar-upload" className="text-gold-400 text-sm font-semibold cursor-pointer hover:text-gold-300">
              Changer la photo
            </label>
          </div>
        </div>
        ...
        <div className="leather-card rounded-xl p-4 stitched">
          ...
          />
          <p className="text-leather-400 text-xs mt-1">Lettres minuscules, chiffres et _ seulement</p>
        </div>
        ...
        <div className="leather-card rounded-xl p-4 stitched">
          ...
          <textarea
            ...
            maxLength={2200}
          />
          <p className="text-leather-400 text-xs mt-1">{formData.bio.length}/2200 caractères</p>
        </div>
