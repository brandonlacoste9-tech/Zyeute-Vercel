    ...
    <div className="min-h-screen bg-black leather-overlay pb-20">
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-4">
        ...
        <div className="leather-card rounded-xl p-4 stitched">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-leather-300 text-sm">Vibrations tactiles lors des interactions</p>
            </div>
            <button
              onClick={() => handleToggle('app.haptics', !preferences.app.haptics)}
        ...
        <div className="leather-card rounded-xl p-4 stitched">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <h3 className="text-white font-semibold mb-1">Fonctionnalités bêta</h3>
              <p className="text-leather-300 text-sm">Accéder aux nouvelles fonctionnalités en développement</p>
            </div>
            <button
              onClick={() => handleToggle('app.betaFeatures', !preferences.app.betaFeatures)}
              className={`relative w-14 h-8 rounded-full transition-colors ${
            ...
            >
              <div
                className={`absolute top-1 left-1 w-6 h-6 bg-white rounded-full transition-transform ${
                  preferences.app.betaFeatures ? 'translate-x-6' : 'translate-x-0'
                }`}
              />
            </button>
          </div>
