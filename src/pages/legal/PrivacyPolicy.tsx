      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="card-edge p-8">
          ...
          <p className="text-white/80 text-lg mb-8 leading-relaxed">
            Chez Zyeuté, ta vie privée est notre priorité. Cette politique explique comment nous
            collectons, utilisons et protégeons tes informations personnelles.
          </p>
          ...
          <section className="mb-10">
            ...
            <h3 className="text-xl font-semibold text-white mb-3">1.4 Données de Localisation</h3>
            <p className="text-white/70 ml-6">
              Région et ville (optionnel, fourni par toi) pour le contenu hyper-local.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white/5 rounded-xl p-6">
                <p className="text-white font-semibold mb-2">🎨 Personnalisation</p>
                <p className="text-white/70">
                  Recommandations de contenu, suggestions de connexions, contenu hyper-local
                </p>
              </div>
              <div className="bg-white/5 rounded-xl p-6">
                <p className="text-white font-semibold mb-2">🛡️ Sécurité et Intégrité</p>
                <p className="text-white/70">
                  Modération par IA, détection de spam, prévention de la fraude, respect des directives
                </p>
              </div>
              <div className="bg-white/5 rounded-xl p-6">
                <p className="text-white font-semibold mb-2">📊 Analyses et Recherche</p>
                <p className="text-white/70">
                  Amélioration du service, statistiques anonymisées, développement de nouvelles fonctionnalités
                </p>
              </div>
              <div className="bg-white/5 rounded-xl p-6">
                <p className="text-white font-semibold mb-2">📧 Communication</p>
                <p className="text-white/70">
          ...
          <section className="mb-10">
            ...
            <p className="text-white/80 leading-relaxed mb-4">
              <strong>3.2 Avec des tiers:</strong> Nous ne vendons JAMAIS tes données personnelles.
              Partage limité avec:
            </p>
            ...
            <p className="text-white/80 leading-relaxed">
              ...
              par la loi, ordonnance judiciaire, ou pour protéger nos droits.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-6">
              ...
              <ul className="space-y-3 text-white/80">
                <li>
                  <strong>✅ Accès:</strong> Télécharger une copie de toutes tes données
                  <br />
                  <span className="text-white/60 text-sm">Paramètres → Sécurité → Télécharger mes données</span>
                </li>
                <li>
                  <strong>✅ Rectification:</strong> Modifier tes informations personnelles
                  <br />
                  <span className="text-white/60 text-sm">Paramètres → Compte → Modifier le profil</span>
                </li>
                <li>
                  <strong>✅ Suppression:</strong> Supprimer ton compte et toutes tes données
                  <br />
                  <span className="text-white/60 text-sm">Paramètres → Compte → Supprimer mon compte</span>
                </li>
                <li>
                  <strong>✅ Portabilité:</strong> Exporter tes données dans un format structuré
                  <br />
                ...
                <li>
                  <strong>✅ Retrait du consentement:</strong> Retirer ton consentement à tout moment
                  <br />
                  <span className="text-white/60 text-sm">Via les paramètres de confidentialité</span>
                </li>
              </ul>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-white/80 leading-relaxed mb-4">
              Nous utilisons des mesures de sécurité de niveau entreprise pour protéger tes données:
            </p>
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="bg-white/5 rounded-xl p-4">
                <p className="text-white font-semibold mb-2">🏢 Infrastructure</p>
                <p className="text-white/60 text-sm">Supabase (certifié ISO 27001)</p>
              </div>
              <div className="bg-white/5 rounded-xl p-4">
                <p className="text-white font-semibold mb-2">🔑 Authentification</p>
              ...
              <div className="bg-white/5 rounded-xl p-4">
                ...
                <p className="text-white/60 text-sm">Principe du moindre privilège</p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="space-y-3 text-white/80">
              <p>• <strong>Contenu actif:</strong> Conservé tant que ton compte est actif</p>
              <p>• <strong>Contenu supprimé:</strong> 30 jours dans nos backups</p>
              <p>• <strong>Compte supprimé:</strong> 90 jours puis suppression complète</p>
              <p>• <strong>Données de sécurité:</strong> 1 an (pour prévenir abus)</p>
              <p>• <strong>Données légales:</strong> Durée requise par la loi (généralement 3-7 ans)</p>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-6">
              <p className="text-white/80 leading-relaxed mb-4">
                <strong>Âge minimum:</strong> 13 ans au Canada (conformément à la LPRPDE).
              </p>
              <p className="text-white/80 leading-relaxed mb-4">
          ...
          <section className="mb-10">
            ...
            <div className="space-y-3">
              <div className="bg-white/5 rounded-xl p-4">
                <p className="text-white font-semibold mb-1">🔐 Cookies Essentiels</p>
                <p className="text-white/60 text-sm">Authentification, sécurité (non désactivables)</p>
              </div>
              <div className="bg-white/5 rounded-xl p-4">
                <p className="text-white font-semibold mb-1">⚙️ Cookies Fonctionnels</p>
          ...
          <section className="mb-10">
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-6">
              ...
              <p className="text-white/70 mt-4">
                <strong>Délai de réponse:</strong> Nous répondons sous <strong>30 jours</strong>
          ...
          <section className="mb-10">
            ...
            <p className="text-white/80 leading-relaxed mb-4">
              <strong>Stockage:</strong> Tes données sont stockées principalement au <strong>Canada</strong>
          ...
          <section className="mb-8">
            ...
            <div className="bg-white/5 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-white/70">
                <li>📧 Email: <a href="mailto:dpo@zyeute.com" className="text-gold-400 hover:underline">dpo@zyeute.com</a></li>
                <li>📧 Privacy: <a href="mailto:privacy@zyeute.com" className="text-gold-400 hover:underline">privacy@zyeute.com</a></li>
          ...
          <div className="border-t border-white/10 pt-8">
            <p className="text-white/40 text-sm text-center mb-4">
              Cette politique peut être modifiée. Nous te notifierons des changements importants.
            </p>
            <p className="text-white/40 text-sm text-center">
              Fait au Québec, pour le Québec. Ta vie privée est respectée! 🇨🇦⚜️🔐
            </p>
          </div>
        </div>
      </div>
