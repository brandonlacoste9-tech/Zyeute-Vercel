    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          ...
          style={{
            background:
              'radial-gradient(circle, rgba(255,191,0,0.15) 0%, rgba(255,191,0,0.05) 40%, transparent 70%)',
          }}
        />
      </div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-10 overflow-visible">
          <div className="relative inline-block overflow-visible">
            ...
            >
              ...
              <svg
                ...
                style={{
                  filter:
                    'drop-shadow(0 0 10px rgba(255,191,0,0.8)) drop-shadow(0 0 20px rgba(255,191,0,0.4))',
                }}
              >
                <defs>
          ...
          <h1
            ...
            style={{
              background: 'linear-gradient(180deg, #FFD700 0%, #FFC125 50%, #B8860B 100%)',
          ...
          <p className="text-white/50 text-sm mt-2">Fait au Québec, pour le Québec 🇨🇦⚜️</p>
        </div>

        {/* Login Card - Leather with Gold Stitching */}
        <div
          className="rounded-3xl p-8 relative"
          style={{
            background: 'linear-gradient(145deg, #1a1815 0%, #0f0e0c 100%)',
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                onFocus={(e) => {
                  e.target.style.borderColor = 'rgba(255,191,0,0.5)';
                  e.target.style.boxShadow =
                    'inset 0 2px 4px rgba(0,0,0,0.3), 0 0 20px rgba(255,191,0,0.1)';
                }}
                onBlur={(e) => {
                  e.target.style.borderColor = 'rgba(255,191,0,0.2)';
            ...
            >
              ...
              <div
                ...
                style={{
                  background: 'linear-gradient(135deg, #FFE55C 0%, #FFD700 50%, #FFC125 100%)',
                }}
              />
            </button>
          </form>
            ...
            <div className="absolute inset-0 flex items-center">
              <div
                ...
                style={{
                  height: '1px',
                  background:
                    'linear-gradient(90deg, transparent, rgba(255,191,0,0.3), transparent)',
                }}
              />
            </div>
