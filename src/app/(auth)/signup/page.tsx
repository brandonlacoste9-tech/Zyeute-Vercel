    ...
    try {
      ...
      navigationTimeoutRef.current = setTimeout(() => {
        if (isMountedRef.current) {
          // Use window.location instead of router.push() to bypass PageTransition animations
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-8 relative leather-bg fur-overlay">
      <div className="w-full max-w-md z-10">
        ...
        <div className="leather-card rounded-2xl p-8 stitched animate-fade-in">
          <h2 className="text-2xl font-bold text-gold-400 mb-6 embossed">Inscription</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="input-premium"
              />
              <p className="text-leather-400 text-xs mt-1">Minimum 6 caractères</p>
            </div>
          ...
          <p className="text-center text-leather-400 text-xs mt-6">
            ...
            <Link href="/legal/terms" className="text-gold-400 hover:underline">
              Conditions d&apos;utilisation
            </Link>{' '}
            et notre{' '}
            <Link href="/legal/privacy" className="text-gold-400 hover:underline">
